                          ...
                          <td colspan="6">
                            ...
                            <div class="row">
                              <div class="col text-right">
                                ...
                                <a type="button" class="btn bg-gradient-warning btn-sm mr-2" style="width: 150px" onclick="">Cancel Meeting</a>
                              </div>
                            </div>
                            <div class="row">
                              <div class="col" id="meeting_id_cancel" style="display: none;">
